...
try:
    ...
    if len(dc_data) > 0:
        ...
        with col1:
            ...
            st.plotly_chart(fig_pue_trend, use_container_width=True)
        ...
        with col2:
            ...
            st.plotly_chart(fig_pue_facility, use_container_width=True)
    ...
    with col1:
        ...
        st.plotly_chart(fig_cfe_trend, use_container_width=True)
    ...
    with col2:
        ...
        st.plotly_chart(fig_cfe_region, use_container_width=True)
