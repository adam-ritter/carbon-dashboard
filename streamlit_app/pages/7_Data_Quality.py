...
try:
    ...
    st.dataframe(consistency_summary, use_container_width=True)
    ...
    if len(results['outliers']) > 0:
        ...
        st.dataframe(outliers_display.head(20), use_container_width=True)
    ...
    if len(results['continuity']) > 0:
        ...
        st.plotly_chart(fig_continuity, use_container_width=True)
        st.dataframe(continuity_display, use_container_width=True)
    else:
